        ...
        <div className="mt-10 sm:mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
          {blogPosts.map((post) => (
            <div
              ...
              className="group cursor-pointer overflow-hidden rounded-[26px] bg-white shadow-card ring-1 ring-slate-200/80 transition-all duration-300 hover:-translate-y-2 hover:shadow-elevated hover:ring-[#1ea6dc]/30 flex flex-col justify-between"
            >
              <div>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
                    <Calendar className="h-3.5 w-3.5 text-[#1ea6dc]" />
                    <span>{post.date}</span>
                    <span>•</span>
                    <span>By {post.author}</span>
                  </div>

                  <h3 className="mt-3 text-base sm:text-lg font-bold text-[#072b58] leading-snug group-hover:text-[#1ea6dc] transition-colors">
                    {post.title}
                  </h3>
              ...
              <div className="px-6 pb-6 pt-2">
                <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#072b58] group-hover:text-[#1ea6dc]">
                  <span>Read More</span>
